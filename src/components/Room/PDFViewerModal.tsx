...
/**
 * Props interface for the PDFViewerModal component
 */
...
/**
 * PDF Viewer Modal Component for Discussion Room
 * 
 ...
 * 
 * @param document - PDF document metadata and URL
 * @param isOpen - Whether the modal is currently open
 * @param onClose - Callback function to close the modal
 * @param className - Additional CSS classes
 */
export function PDFViewerModal({ document, isOpen, onClose, className }: PDFViewerModalProps) {
